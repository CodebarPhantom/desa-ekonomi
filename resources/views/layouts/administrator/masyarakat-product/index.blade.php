...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Produk Masyarakat</h1>
    </div>
    <div class="col-sm-6">
        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('administrator.masyarakat-product.create') }}" class="btn btn-primary btn-flat btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;{{__('Buat').' '.__('Produk').' '.__('Masyarakat') }}</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
