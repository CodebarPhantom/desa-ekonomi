...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Kreativitas Masyarakat</a></li>
...
@section('content')
<div class="row">
    <form role="form" action="{{ route('administrator.masyarakat-creativity.store') }}" method="POST" class="col-md-12" enctype="multipart/form-data">
        @csrf
